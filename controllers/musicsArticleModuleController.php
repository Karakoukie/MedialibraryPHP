...
if (isset($_REQUEST["crudArticleCompositor"])) {
    $updateArticleEditor = $_REQUEST["crudArticleCompositor"];
}
...
if ($updateArticleId != null && $updateArticleTitle != null 
    ...
    $article = new MusicArticleModel($updateArticleId, $updateArticleStock, 
    ...
    $articles = MusicArticleModel::import(null, null, null, null);
